      ...
      <section className="pt-40 pb-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center">
          <div className="inline-flex items-center space-x-2 px-5 py-2.5 bg-white dark:bg-charcoal-900 border border-slate-100 dark:border-white/5 rounded-full shadow-sm mb-10 animate-in fade-in slide-in-from-bottom-4">
            ...
            <span className="text-xs font-bold text-slate-500 dark:text-slate-400 tracking-tight">Next-Gen Learning: Advanced AI Integrated</span>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <FAQItem
              ...
              a="We utilize Gemini 2.0, one of the world's most capable AI models, supplemented by real-time Google Search grounding to ensure technical and factual accuracy."
            />
          </div>
        </div>
      </section>
